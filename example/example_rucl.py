...
vals = ops.band_struct(h,[[0.5,0,0],[0,0,0],[0,0.5,0], [0,0,0.5],[0,0,0],[0.5,0.5, 0.5]], yrange = [-0.5, 0.5], names = ['X', '$\Gamma$', 'Y', 'Z', '$\Gamma$', 'Q'],  proj=range(18), fermi=fermi, pdfname='bs.rucl.pdf') 
